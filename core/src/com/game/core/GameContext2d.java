 ...
 */
public interface GameContext2d extends IGameStateManager, IEntitiesAndSystemsManager,
                                       IScreenManager, IRenderingManager, IController, IAssetLoader, IBlackboard {}
