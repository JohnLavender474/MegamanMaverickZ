...
import com.game.tests.screens.TestMegaBuster.TestPlayer.WButtonTask;
...
public class TestMegaBuster extends ScreenAdapter {
    ...
    static class TestPlayer extends Entity implements Damageable, Faceable, LevelCameraFocusable {
        ...
        private WButtonTask wButtonTask = WButtonTask.JUMP;
        ...
        private BehaviorComponent defineBehaviorComponent() {
            ...
            Behavior wallSlide = new Behavior() {
                ...
                protected void init() {
                    ...
                    setWButtonTask(WButtonTask.JUMP);
                }
                ...
                protected void end() {
                    ...
                    setWButtonTask(WButtonTask.AIR_DASH);
                }
            ...
            Behavior jump = new Behavior() {
                ...
                protected boolean evaluate(float delta) {
                    ...
                    return behaviorComponent.is(JUMPING) ?
                            ...
                            // case 2
                            wButtonTask == WButtonTask.JUMP && controller.isJustPressed(ControllerButton.A) &&
            ...
            Behavior airDash = new Behavior() {
                ...
                protected boolean evaluate(float delta) {
                    ...
                    return behaviorComponent.is(AIR_DASHING) ? controller.isPressed(ControllerButton.A) :
                            controller.isJustPressed(ControllerButton.A) && getWButtonTask() == WButtonTask.AIR_DASH;
                }
        ...
        public void shoot() {
            ...
            Vector2 trajectory = new Vector2(facing == Facing.LEFT ? -PPM : PPM, 0f);
            Vector2 spawn = getComponent(BodyComponent.class).getCenter().add(facing == Facing.LEFT ? -10f : 10f, 0f);
    ...
    static class TestBullet extends Entity implements Damager, CullOnOutOfGameCamBounds, CullOnLevelCamTrans {
        ...
        private BodyComponent defineBodyComponent(Vector2 spawn) {
            ...
            Fixture projectile = new Fixture(this, FixtureType.DAMAGING_BOX);
    ...
    private static class TestWorldContactListener implements WorldContactListener {
        ...
        public void beginContact(Contact contact, float delta) {
            if (contact.acceptMask(FixtureType.FEET, FixtureType.BLOCK)) {
                ...
                if (entity instanceof TestPlayer testPlayer) {
                    testPlayer.setWButtonTask(WButtonTask.JUMP);
                }
            ...
            } else if (contact.acceptMask(FixtureType.DAMAGING_BOX, FixtureType.HIT_BOX) &&
        ...
        public void endContact(Contact contact, float delta) {
            if (contact.acceptMask(FixtureType.FEET, FixtureType.BLOCK)) {
                ...
                if (entity instanceof TestPlayer testPlayer) {
                    testPlayer.setWButtonTask(WButtonTask.AIR_DASH);
                }
            } else if (contact.acceptMask(FixtureType.HEAD, FixtureType.BLOCK)) {
    ...
    public void render(float delta) {
        ...
        message.setText("W button task: " + player.getWButtonTask());
