...
public class TestMegamanAnimations extends ScreenAdapter {
    ...
    private void defineBlocks() {
        ...
        Fixture block4 = new Fixture(bodyComponent4, FixtureType.BLOCK);
        ...
        debugComponent4.addDebugHandle(new DebugHandle(
                block4::getFixtureBox, Color.RED));
        ...
        Behavior jump = new Behavior() {
            ...
            protected void init() {
                ...
                if (behaviorComponent.is(BehaviorType.WALL_SLIDING)) {
                    bodyComponent.applyImpulse((player.isFacing(Facing.LEFT) ? -1f : 1f) * 9f * PPM,
                                               16f * PPM);
    ...
    public void render(float delta) {
        ...
        message2.setText("Body senses:: " + bodyComponent.getBodySenses());
        ...
        message5.setText("Velocity: " + bodyComponent.getVelocity());
        message5.draw(spriteBatch);
        spriteBatch.end();
        runningRight = Gdx.input.isKeyPressed(Keys.RIGHT);
        if (runningRight && bodyComponent.getVelocity().x < MegamanRun.RUN_SPEED * PPM) {
            // bodyComponent.applyImpulse(PPM * 0.85f, 0f);
